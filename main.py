...
from Schema import MotionSensorSchema
...
client = pymongo.MongoClient("mongodb+srv://manud123:<password>@iot2-champ.blytjng.mongodb.net/?retryWrites=true&w=majority", server_api=ServerApi('1'))
db = client.Motion_Sensor
